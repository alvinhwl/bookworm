-- Bookworm v2 Phase 2.0: auth, books, reading log, settings, migration tracking
...
-- Bootstrap profile + settings on sign-up
...
-- Create bucket "covers" (public read) with policies for authenticated upload to {user_id}/*